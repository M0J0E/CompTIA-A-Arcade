// ======================================================
// CompTIA A+ 220-1201 Question Bank
// PART 1A — QUESTIONS 1-60
// ======================================================
...
[3,
"A technician is troubleshooting a desktop PC that is plugged into a UPS. The PC loses the system date/time after every power outage. Which of the following should the technician do to resolve the issue? (Choose two.)",
[
"Run a BIOS update.",
"Swap out the RAM.",
...
[10,
"A user is traveling internationally. They can make and receive phone calls but cannot send or receive email. Which of the following would most likely resolve this issue?",
[
"Disabling the GPS",
...
"Connect to the VPN.",
"Reset the account in Active Directory.",
...
[
"750GB NVMe M.2 SSD",
"2x1TB PCIe SSD in RAID 1",
"2TB SATA 3.5 5,400rpm HDD",
"4TB SAS2.5 15,000rpm HDD"
],
2],
...
"Reconfigure the array as RAID 0."
],
0],

[60,
"A company wants its RAID array set up so that it could lose multiple drives and still have redundancy. Which of the following configurations should the company choose?",
[
"RAID 0",
"RAID 1",
"RAID 5",
...
"Try a smaller font size in the spreadsheet.",
"Change the page orientation.",
"Use a different print driver."
],
2],
...
[63,
"Which of the following types of RAM is best suited to handle errors within the module itself?",
[
"DIMM",
"Dual channel",
"ECC",
...
[
"Authentication is not required on a domain.",
"Licensing costs are minimized.",
"Less manual configuration is needed for each workstation.",
"A virus is automatically contained locally."
],
2],
...
[
"Move the device to a room with a colder temperature.",
...
// Questions 76 and 77 are PBQ/simulation questions.
// They are intentionally skipped by the normal question engine.
...
// Question 89 is a PBQ/simulation question.
...
// Question 119 is excluded from gameplay.
// The source says "Choose two" but provides only one suggested answer.
// The source's suggested answer is B, while the community vote favors E.
// We will preserve the question without letting the game grade it incorrectly.
...
// Question 222 is a HOTSPOT/PBQ and is skipped.
...
// Questions 303 and 304 are HOTSPOT/PBQ questions and are skipped.
...
[331,
"A technician is configuring a desktop computer in a small office. The computer is able to connect to the local file server but is unable to access the internet. The technician runs a command to troubleshoot. Which of the following will most likely restore internet access?",
[
...
// Question 357 is a SIMULATION/PBQ and is skipped.
...
// Question 423 is a DRAG-DROP/PBQ and is skipped.
...
// ======================================================
// CONVERT QUESTION DATA INTO GAME QUESTIONS
// ======================================================

const questions = QUESTION_DATA
  .filter(item => {

    // Fifth value of true means:
    // do not use this question in gameplay.
    const skipQuestion = item[4] === true;
